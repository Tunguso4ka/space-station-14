...
cmd-reset-ent-help = Використання: resetent <Entity UID>
...
cmd-detach-ent-help = Використання: detachent <Entity UID>
cmd-detach-ent-desc = Detach an entity to null-space, as if it had left PVS range.

cmd-local-delete-help = Використання: localdelete <Entity UID>
