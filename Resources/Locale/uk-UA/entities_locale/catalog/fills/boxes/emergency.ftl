ent-BoxSurvival = екстрена коробка
    .desc = Коробка з маленьким балоном внутрі.
    .suffix = Стандартна

ent-BoxSurvivalNitrogen = { ent-BoxSurvival }
    .desc = { ent-BoxSurvival.desc }
    .suffix = Стандартна N2

ent-BoxSurvivalEngineering = екстрена коробка збільшеної ємності
...
ent-BoxSurvivalSecurity = екстрена коробка
...
ent-BoxSurvivalMedical = екстрена коробка
    .desc = It's a box with basic internals inside.
    .suffix = Medical
...
ent-BoxHug = коробка обіймашек
    .desc = Спеціальна коробка для дуже чутливих людей.
    .suffix = Emergency
