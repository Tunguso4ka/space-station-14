...
reagent-name-stimulants = стімулятори
...
reagent-name-experimental-stimulants = експеріментальні стімулятори
...
reagent-name-impedrezene = імпедризин
...
reagent-name-nocturine = ноктюрін
