shared-solution-container-component-on-examine-empty-container = Не вмішує в собі реагентів.
shared-solution-container-component-on-examine-main-text = Вміщує в собі {INDEFINITE($desc)} [color={$color}]{$desc}[/color] {$wordedAmount}
