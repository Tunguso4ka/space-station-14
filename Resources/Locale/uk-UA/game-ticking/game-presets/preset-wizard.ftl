...
wizard-title = Чаклун
wizard-description = На станції помічено Чаклуна! Ніколи не знаєш, що вони можуть зробити.
roles-antag-wizard-name = Чаклун
roles-antag-wizard-objective = Покажить їм щось таке, щоб вони і онукам про це розповідали.
