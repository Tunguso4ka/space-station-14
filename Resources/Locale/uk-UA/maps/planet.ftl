cmd-planet-desc = Трансформує надану мапу у планету з заданним біомом.
cmd-planet-help = {$command} <mapid> <biome>.
cmd-planet-args = Приймає тільки 2 аргумента.
cmd-planet-map = Не можна парсувати {$map} як існуючу мапу.
